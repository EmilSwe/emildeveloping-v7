...
<body>
    ...
    <section class="case" id="case">
        <div class="case-box">
            <img src="assets/img/ipnordic.png" alt="IP-Nordic" class="logo-2">
            <div class="text">
            Uppdraget var att skapa en hemsida där kunderna hos IP-Nordic kunde övervaka statusen och up/down-time hos IP-Nordic.
            <br>
            Detta löste Emil Developing snabbt och smidigt. Och efter 24-48h så levererades produkten till kunden efter att kunden hade fått bedömma och ge feedback på flera olika versioner och sedan finjustera enligt önskemål.
            <br><br>
            <i>"Vi behövde en statusmodul som var enkel att integrera i våra dåvarande plattformar, som kunde skalas efter behov samt vara tillgänlig för våra kunder. Tack vare Emil Developing så kunde vi få en statusmodul efter våra krav."<br>- Oliver (IP-Nordic)</i>
            </div>
        </div>
    </section>
